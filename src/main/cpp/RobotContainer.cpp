...
void RobotContainer::ConfigureBindings()
{
    ...
    // m_operator.Back().WhileTrue(frc2::cmd::Run([this]{m_afcIntake.IntakeSpeed(-1);},{&m_afcIntake})); //Be aware this is a built in negative on variable in the subsytem file
